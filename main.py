...
from data import CDXDataloader, LSTMDataloader
...
def argsparser():
    ...
    # Dataset
    parser.add_argument('--dataset', choices=['LSTM', 'CDX', 'Nottingham'], default='LSTM')  # 'Nottingham')
...
def main(args):
    ...
    elif args.dataset == 'CDX':
        args = CDXDataloader().export(args)
