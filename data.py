...
positive_file = '/Users/abdo/Documents/SEM2/FINTECH/CDXGAN/data/CDXdata/real_data.txt'
...
class CDXDataloader(Dataloader):
    def __init__(self, seq_len=19, vocab_size=5000, start_token=0):
        import pandas as pd
        if not os.path.exists('data/CDXdata/'):
            raise Exception("Please download CDX dataset(and unzip it to `data/CDXdata/`.")
